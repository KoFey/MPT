...
<div>
    ...
    <div class='row'>
        <?php
            require_once "views/components/navTrainers.php";
        ?>

        <div class="col justify-content-center">
            <div class="container"
                 style="background-color: lightgray; border-radius: 50px; overflow: hidden; padding-bottom: 20px">
        ...
        <span id="x" style="color: deepskyblue">
            ...
            <div class="container" id="score" hidden
                ...
                <div class="row justify-content-between">
                    <div class="d-flex flex-column justify-content-center position-relative m-4 text-center"
                         style="background-color: #0dcaf0; width: 300px; height: 200px; border-radius: 20px">
                        <div>
                    ...
                    <div class="d-flex flex-column justify-content-center position-relative m-4 text-center"
                         style="background-color: #3ab22d; width: 300px; height: 200px; border-radius: 20px">
                        <div>
                    ...
                    <div class="d-flex flex-column justify-content-center position-relative m-4 text-center"
                         style="background-color: orange; width: 300px; height: 200px; border-radius: 20px">
                        <div>
